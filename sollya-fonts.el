;;; sollya-fonts.el --- Fonts handling for sollya-mode and inferior-sollya mode.
...
(defconst sollya-builtin '("abs" "absolute" "accurateinfnorm" "acos" "acosh"
			   "asciiplot" "asin" "asinh" "atan" "atanh" "autodiff"
			   "autosimplify" "bashexecute" "binary" "bind"
			   "boolean" "by" "canonical" "ceil" "chebyshevform"
			   "checkinfnorm" "coeff" "composepolynomials"
			   "constant" "cos" "cosh" "decimal" "default" "degree"
			   "denominator" "diam" "dieonerrormode" "diff"
			   "dirtyfindzeros" "dirtyinfnorm" "dirtyintegral"
			   "display" "dyadic" "erf" "erfc" "error" "evaluate"
			   "execute" "exp" "expand" "expm1" "exponent"
			   "externalplot" "externalproc" "file" "findzeros"
			   "fixed" "floating" "floor" "fpfindzeros" "fpminimax"
			   "fullparentheses" "getsuppressedmessages"
			   "guessdegree" "head" "hexadecimal" "honorcoeffprec"
			   "hopitalrecursions" "horner" "implementpoly"
			   "implementconstant" "in" "inf" "infnorm" "integer"
			   "integral" "isbound" "isevaluable" "length" "library"
			   "libraryconstant" "list" "log" "log10" "log1p" "log2"
			   "mantissa" "max" "mid" "midpointmode" "min"
			   "nearestint" "numberroots" "nop" "numerator" "object"
			   "of" "off" "on" "parse" "perturb" "plot" "points"
			   "postscript" "postscriptfile" "powers" "prec"
			   "precision" "print" "printbinary" "printdouble"
			   "printexpansion" "printfloat" "printhexa"
			   "printsingle" "printxml" "quit" "range"
			   "rationalapprox" "rationalmode" "readfile" "readxml"
			   "relative" "remez" "rename" "restart" "revert"
			   "round" "roundcoefficients" "roundcorrectly"
			   "roundingwarnings" "simplifysafe" "searchgal"
			   "showmessagenumbers" "simplify" "simplifysafe" "sin"
			   "single" "sinh" "sort" "sqrt" "string" "subpoly"
			   "substitute" "sup" "supnorm" "suppressmessage" "tail"
			   "tan" "tanh" "taylor" "taylorform" "taylorrecursions"
			   "time" "timing" "tripledouble" "unsuppressmessage"
